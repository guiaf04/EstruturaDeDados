...
bool lista_enc_inserir_apos_iterador(ListaEncInt *lista, int elemento, ItListaEncInt *posicao);
bool lista_enc_remover_apos_iterador(ListaEncInt *lista,ItListaEncInt *posicao);
...
bool filtro(int valor);
int mapear(int valor);

int lista_enc_filtro(ListaEncInt *lista, FiltroCB filtro);
ListaEncInt lista_enc_mapear(ListaEncInt *lista, MapearCB mapear);
